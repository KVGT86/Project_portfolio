...
/* LEDs  */
#define LED_ERROR_PIO PA20_PIO //Red
#define LED_STATUS_PIO PA23_PIO //Green
#define LED_STATUS_PIO2 PA22_PIO //Blue
#define BLUE_LED PA22_PIO
#define RED_LED PA20_PIO
#define GREEN_LED PA23_PIO
